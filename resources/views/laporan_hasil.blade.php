        ...
        <div class="col-md-12"> 
            ...
            <div class="card"> 
                ...
                <div class="card-body"> 
                        ...
                        <div class="row justify-content-center"> 
                            ...
                            <div class="col-md-3"> 
                                <div class="form-group"> 
                                    ...
                                    <input type="date" name="sampai" class="formcontrol" value="{{ $sampai }}"> 
                                ...
                                <div class="form-group"> 
                                    ...
                                    <select class="form-control" name="kategori"> 
                                        ...
                                        @foreach($kategori as $k) 
                                            <option name="kat" <?php if($k->id == $kat){echo "selected='selected'";} ?> value="{{ $k->id }}">{{ $k->kategori }}</option> 
                                        @endforeach 
                                    </select> 
                    ...
                    <a target="_blank" name="print" href="{{ url('/laporan/print?dari=' . $dari . '&sampai=' . $sampai . '&kategori=' . $kat) }}" class="btn btn- btnsecondary">Print</a> 
                    <a target="_blank" name="excel" href="{{ url('/laporan/excel?dari=' . $dari . '&sampai=' . $sampai . '&kategori=' . $kat) }}" class="btn btn- btnsuccess"> Export Exce</a> 
                ...
                <tfoot> 
                    <tr> 
                        ...
                        <td class="text-center bg-success text-white font-weightbold">{{ "Rp. ".number_format($total_pemasukan)." ,-"}}</td> 
                        <td class="text-center bg-danger text-white font-weightbold">{{ "Rp. ".number_format($total_pengeluaran)." ,-" }}</td> 
                    </tr> 
                </tfoot> 
            </table> 
